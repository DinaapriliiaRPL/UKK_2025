...
class _indexprodukState extends State<indexproduk> {
  ...
  List<Map<String, dynamic>> produkFiltered = []; // Variabel untuk menyimpan hasil pencarian
  ...
  Future<void> fetchProduk() async {
    ...
    try {
      ...
      setState(() {
        ...
        produkFiltered = produk; // Set produk yang pertama kali
        isLoading = false;
      });
    } catch (e) {
  ...
  void searchProduk(String query) {
    setState(() {
      searchQuery = query;
      produkFiltered = produk.where((prd) {
        return prd['NamaProduk'].toLowerCase().contains(query.toLowerCase());
      }).toList();
    });
  }
              ...
              children: [
                Padding(
                  ...
                  child: Expanded(
                    child: TextField(
                      onChanged: (query) {
                        searchProduk(query); // Panggil fungsi pencarian ketika teks berubah
                      },
                ...
                Expanded(
                  child: produkFiltered.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemCount: produkFiltered.length, // Gunakan produkFiltered untuk jumlah item
                          itemBuilder: (context, index) {
                            final prd = produkFiltered[index]; // Gunakan produkFiltered untuk data yang ditampilkan
                            return Card(
                              elevation: 4,
